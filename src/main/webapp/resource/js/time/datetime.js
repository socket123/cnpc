(function(){
	var d=document,
		...
		ids=null,
		oInput=null;
	document.write('<iframe frameborder=0 style="z-index:9999999999;display:none;position:absolute;" width="200" height="215" scrolling="no" name="sangcalender" id="sangcalender"></iframe>');
