	...
	<div class="col-xs-12">
		<form class="form-horizontal" role="form" id="addUseForm">
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="articleName" placeholder="请输入文章标题"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="summary" placeholder="请输入文章简介"
						class="col-xs-10 col-sm-5"> <span
						class="help-inline col-xs-12 col-sm-7"> <span
						class="middle"></span>
					</span>
		...
		<!-- 	<div class="form-group">
    		...
    		<div class="form-group">
				...
				<script id="content"  name="content" type="text/plain" style="width:840px;height:500px;">这里写你的初始化内容</script>  
					<!-- <input type="text" id="content" placeholder="请输入文章内容"
						class="col-xs-10 col-sm-5"> <span
						class="help-inline col-xs-12 col-sm-7"> <span
						class="middle"></span>
		...
		<button class="btn btn-info" type="button" id="saveArticle" name="saveArticle">
