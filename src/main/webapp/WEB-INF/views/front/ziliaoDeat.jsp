...
<head>
    ...
    <!-- <script src="${base}/resource/js/detail.js"></script> -->
...
<div class="mainbody_div_deat">
    ...
    <div class="main">
        ...
        <div class="main_div2_hear">
            <p class="main_div2_hear_p1"><span class="main_div2_hear_span1">资料共享</span></p>
        </div>
        <div class="xqy_main_div1">
            <div class="xqy_main_div1_hear1">
                <span class="xqy_main_div1_hear1_span1">${date.name}</span>
            </div>
            <div class="xqy_main_div1_hear2">
                <div class="xqy_main_div1_hear2_time">
                    <span class="xqy_main_div1_hear2_sapn">${date.createtime}</span>
                </div>
        ...
        <div class="xqy_main_div1_hear3">
            <div class="xqeydiv2">
                <p class="xqeydiv2_pw"> ${date.content} </p>
                <p class="xqeydiv2_pw zliaodeatpw">
                    附件： <a  class="zliaodeat"  style="color:cornflowerblue; cursor: pointer" >${date.name}</a>
                    <input class="zliaodeatUrl" type="hidden" value="${date.url}" >
                </p>
...
//            $(".xqeydiv2_pw>span").css("font-size","12px");
        ...
        $(".zliaodeat").click(function () {
            var like =window.confirm("是否下载?")   ;
            var urls = $(".zliaodeatUrl").val();
