...
<div class="mainbody_div_tz">
    ...
    <div class="main_tz">
        <div class="main_tz_div_hear">
            <p class="main_tz_div_hear_p1"><span class="main_tz_div_hear_span1">新闻动态</span></p>
        </div>
                        ...
                        <c:forEach items="${pages.dataList}" var="article" varStatus="status">
                            <li class="main_tz_div_footes_li">
                                <p class="main_tz_div_foot_p1">
                                    <a href="newAcdetails.html?id=${article.id}" class="main_tz_div_footes_span1">${article.title}</a>
                                </p>
...
//        current：当前页
        $(".tcdPageCode").createPage({
            ...
            backFn:function(p){
                window.location.href ="newzixun.html?currentIndex="+p+"";
            }
        });
