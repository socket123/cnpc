    ...
    <div class="main">
        <div class="wenxz_main_div_left">
            <div class="main_tz_div_footes wenxz_main_div_left_div1">
                <ul class="main_tz_div_footes_ul">
                    ...
                    <c:forEach items="${pages.dataList}" var="data" varStatus="status">
                    <li class="main_tz_div_footes_li">
                        <p class="main_tz_div_foot_p1">
                            <a href="ziliaofendeat.html?id=${data.id}" class="main_tz_div_footes_span1">${data.name}</a>
                        </p>
                        <p class="main_tz_div_foot_p2">
                            <span class="main_tz_div_footes_span2"> ${data.createtime}</span>
                        </p>
                    </li>
                    </c:forEach>
                    </c:when>
        ...
        <div class="wenxz_main_div_right">
            <div class="main_xw_right_div1">
                <ul>
                    <c:choose>
                    <c:when test="${pageskeyw.totalNum>0}">
                        <c:forEach items="${pageskeyw.dataList}" var="pageskeyw" varStatus="status">
                    <li class="main_xw_right_div1_li">
                        <div class="changdiv">
                        <img src="${base}/resource/img/wpss${status.index}.png" class="main_xw_right_div1_img"/>
                            </div>
                        <p class="main_xw_right_div1_p1">
                            <a href="ziliaofen.html?type=${pageskeyw.keyword}"  class="main_xw_right_div1_span1">${pageskeyw.keyword}</a>
                        </p>
                    </li>
                        </c:forEach>
                    </c:when>
...
//        current：当前页
        $(".tcdPageCode").createPage({
            ...
            backFn:function(p){
                window.location.href ="ziliaofen.html?type="+type+"&currentIndex="+p+"";
            }
        });
