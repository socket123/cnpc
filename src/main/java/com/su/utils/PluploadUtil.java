...
public class PluploadUtil {
    ...
    public static String upload(Plupload plupload, File dir) throws IllegalStateException, IOException {
        ...
        String filePath = upload(plupload, dir, filename);
     ...
     * @throws IOException
     */
    public static String upload(Plupload plupload, File dir, String filename) throws IllegalStateException, IOException {
        ...
        if (map != null) {
            ...
            while (iter.hasNext()) {
                ...
                for (MultipartFile multipartFile : fileList) {
                    ...
                    System.out.print("multipartFile.getOriginalFilename()" + multipartFile.getOriginalFilename());
                    // 创建新目标文件

                    filePaths = filename + multipartFile.getOriginalFilename();
                    File targetFile = new File(dir.getPath() + "/" + filename + multipartFile.getOriginalFilename());
